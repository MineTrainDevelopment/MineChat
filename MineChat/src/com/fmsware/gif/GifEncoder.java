...
/**
 * NOTE: I stoll this code from <a href="https://github.com/rtyley/animated-gif-lib-for-java/blob/master/src/test/java/com/madgag/gif/fmsware/TestAnimatedGifEncoder.java#value">GitHub</a> 
 * <br> I just adjusted it slightly to fit my needs.
 * 
 * <p> Class AnimatedGifEncoder - Encodes a GIF file consisting of one or
 * more frames.
 * <pre>
 * Example:
...
public class GifEncoder {
	 ...
	 * Sets the number of times the set of GIF frames
	 * should be played.
	 * <br>NOTE: Must be invoked before the first
	 * image is added.
	 *
	 * @param repeat if the gif be looped.
	 */
  ...
  public void setBackground(Color c) {
	...
	public boolean addFrame(BufferedImage im, int frameDelay) {
		...
		try {
			...
			writeGraphicCtrlExt(Math.round(frameDelay / 10.0f)); // write graphic control extension
	 ...
	 * not invoked.
	 *
	 * @param frameSize {@link Dimension} frame dimension.
	 */
